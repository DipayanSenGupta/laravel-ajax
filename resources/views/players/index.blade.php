...
<div class="container">
    <h2 style="margin-top: 12px;" class="alert alert-success">Laravel 5.7 First Ajax CRUD Application - <a href="" target="_blank" >TutsMake</a></h2><br>
    <div class="row">
        <div class="col-12">
  ...
  $(document).ready(function () {
   ...
   /* When click edit user */
    $('body').on('click', '#edit-user', function () {
      ...
      $.get('players/' + user_id +'/edit', function (data) {
